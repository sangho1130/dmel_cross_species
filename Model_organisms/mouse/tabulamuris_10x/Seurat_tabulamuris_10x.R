...
### tabula muris 10X ###
tm_tenx <- readRDS('droplet_Marrow_seurat_tiss.counts.Rds')
label <- readRDS('droplet_Marrow_seurat_tiss.label.Rds')
head(label)
tm_tenx_bcs <- intersect(rownames(label), colnames(tm_tenx))
