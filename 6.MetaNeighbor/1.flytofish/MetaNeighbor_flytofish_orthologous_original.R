...
var_genes <-  variableGenes(dat = merged_se, exp_labels = merged_se$study_id); length(var_genes) # 351 | 351
...
pheatmap(celltype_NV, border_color = NA, fontsize = 9, 
         ...
         #filename = 'celltype_origin/MetaNeighbor_flytofish_orthologous.celltype_origin_AUROC.clustered.pdf')
dev.off()
