...
mouse_tm10x <- readRDS('../../../mouse/tabulamuris_ss2/tmp/tm_ss2.harmony.clustered.Rds')
head(mouse_tm10x@meta.data); nrow(mouse_tm10x@meta.data) # 5037
...
conserved[1:6, 1:10]; nrow(conserved) # 12256
...
for (seed in c(210605221:210605225)){
  set.seed(seed)
