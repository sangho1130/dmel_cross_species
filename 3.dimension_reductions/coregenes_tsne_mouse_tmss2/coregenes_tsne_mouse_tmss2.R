...
mouseobj <- readRDS('../../mouse/tabulamuris_ss2/tmp/tm_ss2.harmony.clustered.Rds')
head(mouseobj@meta.data); nrow(mouseobj@meta.data)
...
for (seed in c(210525041:210525045)){
  set.seed(seed)
  ...
  length(rand_bc)
  #rand_bc <- rownames(mouseobj@meta.data)
